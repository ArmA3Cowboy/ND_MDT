...
SetTimeout(500, function()
    ...
    local sqlFiles = {
        "bridge/qbx/database/bolos.sql",
        "bridge/qbx/database/records.sql",
        "bridge/qbx/database/reports.sql",
        "bridge/qbx/database/weapons.sql",
        "bridge/qbx/database/alterQbox-DB.sql"
    }
    for i = 1, #sqlFiles do
...
function Bridge.createInvoice(characterId, fine)
    ...
    print("[^8WARNING^7] Go to: ^4@ND_MDT/bridge/qbx/server.lua^7 to implement!")
end
